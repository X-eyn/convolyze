...
import { BsMicrosoftTeams } from 'react-icons/bs';  // Using Bootstrap icons instead
...
export const MeetingAnalysis = ({ meeting }: { meeting: any }) => {
  ...
  // In MeetingAnalysis component, update the getAllStats function
  const getAllStats = useCallback(async () => {
        ...
        const percentages = await askModel(
            {
                ...
                query: `Analyze the meeting transcript and provide detailed participant engagement statistics.
                       ...
                       Ensure percentages add up properly and reflect actual participation levels.`,
    ...
    let parsedData;
    try {
      console.log('Raw response:', percentages); // Debug log
